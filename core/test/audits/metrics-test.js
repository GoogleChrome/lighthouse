...
const pwaTrace = readJson('../fixtures/artifacts/paul/trace.json', import.meta);
const pwaDevtoolsLog = readJson('../fixtures/artifacts/paul/devtoolslog.json', import.meta);
